          ...
          <div class="col-lg-4 col-md-6 mb-4" ng-repeat="product in products">
            ...
            <div class="card h-100 border" >
              ...
              <div class="purchase" style="text-align: center">
                ...
                <!-- natalia's button -->
                 <!--<button class="btn-block btn-lg" style="padding-left:0%; padding-right:0%; margin-left:0%" href='<c:url value="/admin/products/`{{product.productsId}}`"/>'>Edit</button>--> 

                <!-- andreas button -->
                <!--button id="edit" style="position:relative; top:72px; right: 292px" onclick="window.location.href='<c:url value="/admin/products/{{product.productsId}}"/>'>Edit</button--> 
              </div>
              <!-- /EDIT -->
